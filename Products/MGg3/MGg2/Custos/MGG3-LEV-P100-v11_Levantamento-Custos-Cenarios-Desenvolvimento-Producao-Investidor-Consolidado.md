---
codigo_fonte: MGG3-LEV-P100-v11
titulo: Levantamento de custos da P100 — Cenário real de Desenvolvimento, projeção de Produção e seção do investidor IFHAN — Revisão Plentz-08
produto: MGgrafeno / MGG3
escala: P100 — 2 módulos KonMix de cisalhamento em tanques de 100 L (200 L nominais por lote combinado)
versao: 11
revisao: Plentz-08 + Correção-Carmen-duplicidade-lotes
data: 2026-05-31
data_correcao: 2026-06-01
status: consolidado_cenario_real_desenvolvimento_com_producao_anexa_e_secao_investidor
base_anterior: MGG3-LEV-P100-v10
...
| OPEX de referência v9 (caixa, corrigido)                                                     |     R$ 2.323.444/ano | Base histórica de referência (**261 lotes de 200 L/ano = 5.220 kg grafite**, 20 kg/lote, equipe 8 pessoas, CQ US$5k/mês); sem depreciação. Corrigido da duplicidade de lotes — ver §27                                                                  |
| OPEX de referência v9 (técnico completo, corrigido)                                          |     R$ 2.490.020/ano | OPEX caixa + depreciação gerencial R$ 166.576                                                                                                                                                                                                           |
...
O valor a empenhar para a planta funcionar no **Ano 1** é de **R$ 5,73 milhões (caso-base)**, dentro de uma faixa defensável de **R$ 4,99 MM a R$ 6,57 MM**.

| Cenário | Valor a empenhar (Ano 1) | Composição |
|---|---:|---|
| Otimista / piso técnico | R$ 4,99 MM | CAPEX R$ 430k + OPEX R$ 4,16 MM + giro R$ 400k |
| **Caso-base** | **R$ 5,73 MM** | CAPEX R$ 610k + OPEX R$ 4,62 MM + giro R$ 500k |
| Conservador / teto de funding | R$ 6,57 MM | CAPEX R$ 915k + OPEX R$ 5,06 MM + giro R$ 599k |
...
- **Operacional (recorrente): R$ 4,62 MM** — OPEX do Cenário Desenvolvimento, o cenário real do Ano 1 (§8.5). Já inclui energia.
...
**Curva de caixa.** O cheque precisa estar comprometido no início do Ano 1, mas o caixa sai escalonado: o esforço se concentra nos **primeiros 90 dias** (recomissionamento + arranque de giro), estabilizando em torno de **R$ 385 mil/mês** de OPEX a partir do 4º mês. O recomissionamento concentra o risco no início; depois a operação é previsível.

| Período | Desembolso (caso-base) |
|---|---:|
| Mês 1 | R$ 629k (CAPEX R$ 244k + OPEX R$ 385k) |
| Mês 2 | R$ 929k (CAPEX R$ 244k + giro R$ 300k + OPEX R$ 385k) |
| Mês 3 | R$ 707k (CAPEX R$ 122k + giro R$ 200k + OPEX R$ 385k) |
| Meses 4–12 | R$ 385k/mês (OPEX), total R$ 3,465 MM |
| **Total Ano 1** | **R$ 5,73 MM** |
...
- **Esforço concentrado na abertura:** no Ano 2, sem repetir CAPEX e giro, o run-rate cai para **R$ 4,74 MM/ano** (R$ 4,62 MM de OPEX + R$ 120k de aluguel CDTN). O maior esforço de caixa está na implantação e estabilização, não em subsídio indefinido.

> Para o IFHAN, a P100 não é uma aposta em receita de Ano 1; é uma opção estratégica exclusiva sobre uma plataforma de materiais avançados para eficiência energética, com cobre-grafeno como primeira aplicação prioritária, financiada por um cheque inicial de R$ 5,73 MM (caso-base) e com o esforço de implantação concentrado nos primeiros 90 dias.
...
|---|---|---|
| Capital de giro inicial | Exclusão explícita do modelo OPEX/CAPEX | Provisionar separadamente: ~R$ 387–581 mil para 2–3 meses de OPEX caixa mensal médio ~R$ 193.620/mês (corrigido — §27). **Nota:** as faixas de giro citadas em §2-A.2 (R$ 400k/500k/599k) derivam deste valor pré-correção; o caso-base de R$ 500k permanece válido dentro da nova faixa, mas os limites otimista/conservador devem ser revalidados (deslocamento sub-1%, dentro da faixa do cheque) |
...
| Indicador derivado (v9 nominal, corrigido — §27) | Valor |
|---|---:|
| Custo caixa por lote (200 L) | R$ 8.902 |
| Custo técnico completo por lote (200 L) | R$ 9.540 |
| Custo caixa por kg (base v9) | R$ 451 |
| Custo técnico completo por kg (base v9) | R$ 483 |
| OPEX caixa mensal de referência | R$ 193.620 |
...
Confirmação de cobertura econômica (corrigida — ver §27): na P100 com produção nominal de **5.157 kg/ano**, a receita no piso de **US$ 50/kg** (câmbio R$ 5/US$) gera **R$ 1.289.340/ano**, cobrindo **~52% do OPEX Técnico Completo** de R$ 2.490.020/ano, antes de impostos, mix comercial e preço validado. No teto da régua de mercado (**US$ 200/kg**), a mesma produção geraria ~R$ 5,16 MM/ano, cobrindo com folga o OPEX nominal. **A planta não cruza o ponto de equilíbrio no piso da régua** — só o cruza acima de ~US$ 96/kg (NPG/GNP técnico). Esta é a leitura honesta para o investidor.

> **Correção da duplicidade de lotes.** Versões anteriores afirmavam cobertura de **~101%** no piso US$ 50/kg. Esse número decorria da dupla contagem de lotes: a v9 dobrou a carga por lote (10→20 kg) **sem** halvar a contagem de 522 lotes/ano, dobrando artificialmente a produção (de ~5.157 para 10.315 kg/ano) e a receita (de R$ 1,29 para R$ 2,58 MM/ano). Com a produção física correta (~5.157 kg/ano), a cobertura no piso volta a **~52%** — exatamente o valor anterior à v9. Ver §4.3, §20 e §27.

A mesma receita corrigida de R$ 1.289.340/ano cobre **~52% do OPEX Produção v10** (R$ 2.481.000/ano — Cenário Produção com equipe enxuta de 5 pessoas e indiretos de mercado, sem depreciação gerencial). Os dois denominadores (OPEX Técnico Completo v9 e OPEX Produção v10) são distintos mas convergem para a mesma leitura de ~52% de cobertura no piso. Ver reconciliação em §10.
...
A métrica relevante para Desenvolvimento **não é R$/kg nem OPEX por lote nominal**. A P100 piloto carrega estrutura fixa de capacidade técnica de ~R$ 3,13 MM/ano; as campanhas apenas absorvem essa capacidade.

| Cadência | OPEX anual | OPEX mensal | Lotes/ano | Uso vs. nominal | Variável anual implícita |
|---|---:|---:|---:|---:|---:|
| Conservador — 8 campanhas (~4 lotes/campanha) | R$ 3.654.400 | R$ 304.500 | 32 | 12,3% | R$ 520.000 |
| Base — 12 campanhas (5 lotes/campanha) | R$ 4.094.400 | R$ 341.200 | 60 | 23,0% | R$ 960.000 |
| Intensivo — 18 campanhas (~6 lotes/campanha + à la carte) | R$ 4.844.400 | R$ 403.700 | 108 | 41,4% | R$ 1.710.000 |
...
A diferença entre v9 R$ 483/kg e a projeção de Produção R$ 1.790/R$ 896/R$ 448 não é contradição — é mudança de pool e método de alocação. (Valores corrigidos da duplicidade de lotes — ver §27.)

| Dimensão | v9 (referência histórica, corrigida) | v10 Produção (Cenário D2) |
|---|---|---|
| Equipe | 8 pessoas (equipe técnica completa) | 5 pessoas (equipe enxuta de produção) |
| OPEX caixa | R$ 2.323.444/ano (sem depreciação) | R$ 2.481.000/ano (caso-base, inclui indiretos de mercado) |
| OPEX técnico completo | R$ 2.490.020/ano (caixa + depreciação R$ 166.576) | — (depreciação não incluída no caso-base D2) |
| Residual D2 vs v9 caixa | — | +R$ 157.556/ano (D2 é *mais caro* que v9 caixa; equipe menor mas indiretos empresariais adicionados) |
| Residual D2 vs v9 técnico completo | — | −R$ 9.020/ano (D2 é marginalmente *mais barato* que v9 com depreciação; mudança de pool compensa) |
| Custo médio ponderado | R$ 483/kg (OPEX técnico completo / 5.157 kg) | R$ 481/kg físico (OPEX D2 / 5.157 kg — média sem alocação por produto) |
...
**Nota de leitura crítica:** o D2 caso-base (R$ 2.481.000/ano) é *mais caro* que o v9 OPEX caixa corrigido (R$ 2.323.444/ano) em +R$ 157.556/ano, não mais barato. A equipe menor (5 vs 8 pessoas) gera economia de ~R$ 967.200/ano, mas os indiretos empresariais de mercado adicionados (R$ 712.800/ano — benchmark §7.2) e a maior estrutura de insumos de produção e manutenção absorvem parte dessa economia. O D2 fica marginalmente mais barato apenas quando comparado ao v9 OPEX *técnico completo* corrigido (R$ 2.490.020/ano, que inclui R$ 166.576/ano de depreciação gerencial não presente no D2 caso-base) — diferença de apenas R$ 9.020/ano.

**Leitura para o investidor:** as duas leituras coexistem e respondem a perguntas diferentes. v9 R$ 483/kg é o custo técnico completo médio — base de planejamento e cobertura econômica histórica. v10 Produção R$ 1.790/R$ 896/R$ 448 é o custo por produto em regime dedicado com equipe enxuta e indiretos de mercado de EPP. Comparar diretamente os dois sem declarar a diferença de pool e método de alocação gera equívoco analítico.
...
| Faixa externa de preço de referência | US$ 50–200/kg para NPG/GNP técnico | Benchmark externo v9; revalidado em §7 | Régua de mercado. A US$ 50/kg e câmbio R$ 5/US$, receita no piso (R$ 1.289.340/ano — corrigida, §27) cobre ~52% do OPEX Técnico Completo v9 (R$ 2.490.020 — base §7.1) e ~52% do OPEX Produção v10 (R$ 2.481.000 — base §9.2). Equilíbrio só acima de ~US$ 96/kg; ver §7.1 e §10. |
...
| OPEX caixa anual v9 | R$ 2.323.444/ano | Soma v9 §6 (corrigida — §27) | Base de custo caixa da P100 piloto com equipe de 8 pessoas |
| OPEX técnico completo v9 | R$ 2.490.020/ano | OPEX caixa + depreciação gerencial R$ 166.576 | Base para custo técnico completo de R$ 483/kg |
| Custo técnico médio v9 | R$ 483/kg; R$ 9.540/lote | R$ 2.490.020 / 5.157,36 kg e / 261 lotes (corrigido — §27) | Leitura executiva/banco para custo médio do mix |
| Capital de giro inicial | ~R$ 387–581 mil | 2–3 meses de OPEX caixa mensal médio ~R$ 193.620 (corrigido — §27) | Exclusão consciente do CAPEX e OPEX; provisionar separadamente. Faixas de §2-A a revalidar (caso-base R$ 500k permanece válido) |
...
Na base atual (5,16 t/ano, R$ 483/kg técnico completo — corrigido, §27):
- Se a produção efetiva cair para 3,6 t/ano: R$ 692/kg.
- Se a produção efetiva subir para 7,2 t/ano: R$ 346/kg.
- Para ramp-up de 157–209 lotes de 200 L/ano: R$ 603–803/kg técnico completo.

Cada variação de R$ 50 mil/ano no contrato de CQ altera o custo em ~R$ 9,70/kg. O pesquisador adicional de aplicações e fomento: +R$ 210 mil/ano (+~R$ 41/kg) antes de qualquer receita ou subvenção gerada.
...
**O que NÃO mudou.** O Cenário (1) — Desenvolvimento (corpo principal, §8) e o cheque do investidor §2-A (R$ 5,73 MM/ano) são construídos sobre lotes de **100 L / 10 kg** e **não** foram afetados: 156 lotes-teste/ano de 100 L = 1.560 kg de grafite/ano permanecem corretos. A linha de energia (§6.4) também permanece, pois escala com horas-módulo (522 operações de módulo = 261 lotes × 2 módulos).
