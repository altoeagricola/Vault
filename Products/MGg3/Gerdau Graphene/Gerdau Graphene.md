...
A Gerdau Graphene opera como empresa de aditivos industriais à base de grafeno: seleciona grades, domina dispersão/incorporação e vende formulações aplicáveis em produtos do cliente. Para MGg3, a leitura central é que o ativo não é "grafeno" isolado, mas a combinação **grade correto + dispersão + rota de processamento + validação por aplicação**.

## Navegação principal

| Pergunta | Nota principal | Complemento |
|---|---|---|
...
- **Modelo de negócio:** atuação nos elos de seleção, dispersão, blending e formulação; a dispersão aparece como gargalo técnico e fonte de margem.
...
| Código | Status | Nota / caminho |
|---|---|---|
| GG-APRES01 | Criado | [[GG-APRES01_Grafeno-Nanomaterial]] |
| GG-CM018 | Criado | [[GG-CM018_Aditivo-Escoria]] |
| GG-RT | Criado | [[GG-RT_Resultados-Tecnicos-Concreto]] |
| GG01 | Criado | [[GG01_Allnex-Introduction]] |
| GG02 | Criado | [[GG02_Graphene-Flagship]] |
...
- Tratar confidencialidade como campo obrigatorio em todos os registros.
- Separar dado extraido do documento de inferencia estrategica para MGg3.
- Registrar metricas quantitativas com unidade, comparador e condicao experimental.
- Manter anexos no local atual como evidencia primaria; não usar anexo como interface normal de consulta.
