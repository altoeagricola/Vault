...
- **Expertise complementar à do [[Edgar O. Machado]]** — Edgar traz Data Architecture e Governance; Julio traz a camada semântica e de representação de conhecimento. A combinação cobre a pilha completa para um AI-KB com fundamentação formal
- Vínculo pessoal de longa data (CEFETES) — alinhamento de confiança para colaboração técnica

---

## Conexões com Produtos

- [[Products/AI-KB/AI-KB]] — potencial contribuição em modelagem ontológica da base de conhecimento de IA
- [[Products/PKM/PKM]] — potencial contribuição em ontologia do grafo de conhecimento do vault
