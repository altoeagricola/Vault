---
context: "[[Connections]]"
tipo: Entidade Paraestatal / Sistema S
...
Entidade de direito privado, paraestatal, integrante do **Sistema S**. Criada pela Lei nº 8.315/1991, vinculada à **CNA** (Confederação da Agricultura e Pecuária do Brasil). Financiada por contribuição compulsória sobre a comercialização de produtos agrossilvipastoris e folha de pagamento de empresas rurais. Serviços oferecidos gratuitamente ao público.

Atua em três frentes:
- **FPR** — Formação Profissional Rural (cursos técnicos e profissionalizantes)
- **PS** — Promoção Social
- **ATeG** — Assistência Técnica e Gerencial

Presença nacional via 27 Administrações Regionais (uma por estado + DF) e rede de mais de 235 polos presenciais (até abr/2024).
