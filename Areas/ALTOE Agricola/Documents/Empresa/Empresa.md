...
| Campo | Dado |
|-------|------|
| Razão Social | ALTOE AGRICOLA LTDA |
| CNPJ | 65.507.623/0001-09 |
| JUCEES | 32203794172 |
| Início das Atividades | 26/02/2026 |
| Sede | Avenida Dom Bosco, 114, Lote Catelan, Centro, Marilândia-ES, CEP 29725-000 |
| Porte | Microempresa (ME) |
| Foro | Comarca de Marilândia-ES |

**CNAEs:**
- 7490-1/03 — Serviços de agronomia e de consultoria às atividades agrícolas e pecuárias *(principal)*
...
| Sócio | CPF | Quotas | % | Papel |
|-------|-----|--------|---|-------|
| [[Rodrigo Altoé]] | 082.500.017-37 | 49.500 | 99% | Sócio-administrador |
| [[Luis Eduardo Gottardo]] | 058.694.597-02 | 500 | 1% | Sócio — responsável técnico |

> Quadro atual conforme 1ª Alteração Contratual (17/03/2026). Luis Eduardo foi admitido para cumprir exigência de técnico responsável como sócio — requisito do BB e do MCR para credenciamento bancário.
